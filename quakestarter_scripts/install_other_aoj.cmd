...
echo %func_mapjam2_installed%  1: func_mapjam2 - Func Map Jam 2 - IKblue/IKwhite Theme ^(2014^)
echo %func_mapjam3_installed%  2: func_mapjam3 - Func Map Jam 3 - Zerstoerer theme ^(2014^)
echo %retrojam6_installed%  3: retrojam6 - Retro Jam 6 - Egyptian theme ^(2017^)
echo %grim_rezipped_installed%  4: grim_rezipped - The Grim Outpost ^(2018^)
echo.
set menu_choice=:eof
